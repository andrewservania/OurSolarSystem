...
using namespace std;
	...
	//void drawCircle( float Radius, int numPoints, bool visible, float customV);

static KeyBoardControl keyBoardControl;



#pragma region clean up this weird section ASAP! - Andy
...
#pragma endregion
	...
	void Display(void)
	{
		...
		Planets::CreateJupiter(solarSystemRotation);	
		Planets::CreateMars(solarSystemRotation);
		Planets::CreateMercury(solarSystemRotation);
		Planets::CreateNeptunus(solarSystemRotation);
		Planets::CreatePlanetEarth(solarSystemRotation);
		Planets::CreatePluto(solarSystemRotation);
		Planets::CreateSaturn(solarSystemRotation);
		Planets::CreateUranus(solarSystemRotation);
		Planets::CreateVenus(solarSystemRotation);
	...
	// Rotate around universe mousewheel
